...
-- ----------------------------
INSERT INTO `base_member` VALUES (67, NULL, '微服汇', 'https://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTK3JVibuZg8wiaKG9ExyVJJT2R4s398eropw2qU7GhJEwgwNB8Y56GWh4dDHPSYTNcJXgmkvz4809SA/132', NULL, '李正乐', '18112907714', 'test', '123456', '2021-01-15 16:17:34');
INSERT INTO `base_member` VALUES (68, 'o1HEb0bbQgdd1aPNyr2ZXvutSU8U', '清风', 'https://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTK3JVibuZg8wiaKG9ExyVJJT2R4s398eropw2qU7GhJEwgwNB8Y56GWh4dDHPSYTNcJXgmkvz4809SA/132', '1', '微服汇', '18112907714', NULL, NULL, '2021-03-09 19:48:51');
...
CREATE TABLE `bbs_collect`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '收藏' ROW_FORMAT = Dynamic;
...
CREATE TABLE `bbs_follow`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '关注' ROW_FORMAT = Dynamic;
...
CREATE TABLE `bbs_like`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '点赞' ROW_FORMAT = Dynamic;
...
CREATE TABLE `bbs_reply`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '跟帖' ROW_FORMAT = Dynamic;
...
CREATE TABLE `bbs_topic`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '主贴' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bbs_topic
-- ----------------------------
INSERT INTO `bbs_topic` VALUES (32, '	spring微服务如何做到无损部署更新?', 68, NULL, 1, 'spring微服务如何做到无损部署更新?	spring微服务如何做到无损部署更新?', 'http://localhost:10001/img/video.mp4', 1, '2021-04-06 17:30:13');
INSERT INTO `bbs_topic` VALUES (35, 'springcloud框架讲解', 68, NULL, 1, 'springcloud 来了', NULL, 1, '2021-04-06 18:22:13');
INSERT INTO `bbs_topic` VALUES (36, 'springboot android框架讲解', 68, NULL, 1, 'springboot uinapp 来了', NULL, 0, '2021-05-06 18:22:13');
INSERT INTO `bbs_topic` VALUES (37, 'springboot 小程序框架讲解', 67, NULL, 1, 'springboot uinapp 来了', NULL, 0, '2021-05-06 18:22:13');
INSERT INTO `bbs_topic` VALUES (38, 'springboot vue框架讲解', 67, NULL, 1, 'springboot uinapp 来了', NULL, 0, '2021-05-06 18:22:13');
INSERT INTO `bbs_topic` VALUES (39, 'springboot html框架讲解', 67, NULL, 1, 'springboot uinapp 来了', NULL, 1, '2021-05-06 18:22:13');
INSERT INTO `bbs_topic` VALUES (40, 'springboot uinapp框架讲解', 67, NULL, 1, 'springboot uinapp 来了', NULL, 1, '2021-05-06 18:22:13');
...
CREATE TABLE `bbs_topic_pic`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '主贴图片' ROW_FORMAT = Dynamic;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '2803180149@qq.com', '18021418906', 1, '2021-08-02 11:11:11');
